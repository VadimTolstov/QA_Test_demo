...
import hw_18_rest_api_Assured.lecture.in.reqres.endpoints.Endpoints;
import hw_18_rest_api_Assured.lecture.in.reqres.testdata.RandomUser;
...
public class ReqressTests extends TestBase{
    ...
    public void getListUsers(String count){
        ...
        response
                .then()
                .statusCode(200)
                .assertThat().body(matchesJsonSchemaInClasspath("hw_18/shemes/listUsersShceme.json"));
    ...
    public void getSingleUser(){
        ...
        .then()
            .statusCode(200)
            .assertThat().body(matchesJsonSchemaInClasspath("hw_18/shemes/singleUserShceme.json"))
    ...
    public void registerNewUser(){
        ...
        given().body(gson.toJson(body))
                ...
                .body(matchesJsonSchemaInClasspath("hw_18/shemes/createUserShceme.json"));
    ...
    public void updateUser(){
        ...
        given().body(gson.toJson(body))
                ...
                .assertThat().body("name", equalTo(name))
                .assertThat().body("job",equalTo(job))
                .body(matchesJsonSchemaInClasspath("hw_18/shemes/updateUserShceme.json"));
    }
}
