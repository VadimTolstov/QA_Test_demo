...
public class FileParsingTest2 {


    private final ClassLoader cl = FileParsingTest2.class.getClassLoader();

    @Test
    void zippedPdfParseTest() throws Exception {
        try (InputStream is = cl.getResourceAsStream("testdata_hw_10/lecture/zipFiles (1).zip");
    ...
    void jsonTest() throws Exception {
        ...
        try (InputStream is = cl.getResourceAsStream("testdata_hw_10/lecture/jackson.json");
